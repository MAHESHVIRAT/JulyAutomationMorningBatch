...
//		relativeXPathUsingPartialTextContent();
	...
	static void navigate()
	{
		try
		{
			oBrowser.get("file:///F:/Mahesh/JAVA-SELENIUM/Xpath%20cases/tests_2nd_SEPT_2021/Sample.html");
			Thread.sleep(4000);
		}catch(Exception e)
		{
			e.printStackTrace();
...
//			obj.dismiss();
	...
	static void relativeXPathUsingAttributeValueAlone()
	{
		try
		{
			oBrowser.findElement(By.xpath("//*[@*='windows']")).click();
		}catch(Exception e)
		{
			e.printStackTrace();
		}
	...
	// Click on a link and navigate back
		...
		static void relativeXPathUsingTextContent()
		{
			try
			{
				String mahesh="Eclipse";
				oBrowser.findElement(By.xpath("//a[text()='"+mahesh+"']")).click();
			}catch(Exception e)
			{
				e.printStackTrace();
			}
