...
public class Assignment2 {
	...
	static void modifyUser()
	{
		try
		{
			...
			oBrowser.findElement(By.id("userDataLightBox_firstNameField")).sendKeys("mahesh");
			oBrowser.findElement(By.id("userDataLightBox_lastNameField")).clear();
			oBrowser.findElement(By.id("userDataLightBox_lastNameField")).sendKeys("kc");
			oBrowser.findElement(By.id("userDataLightBox_emailField")).clear();
			oBrowser.findElement(By.id("userDataLightBox_emailField")).sendKeys("mahesh@gmail.com");
			oBrowser.findElement(By.id("userDataLightBox_usernameField")).clear();
			oBrowser.findElement(By.id("userDataLightBox_usernameField")).sendKeys("mahesh");
